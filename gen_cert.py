...
class CertificateGen(object):
    ...
    def _generate_stanford_cme_certificate(
        ...
        (fonttag, fontfile, name_style) = font_for_string(
            fontlist_with_style(fontlist, style_big_name_text),
            student_name_string
        )
        ...
        (fonttag, fontfile, course_style) = font_for_string(
            fontlist_with_style(fontlist, style_big_course_text),
            course_title
        )
        ...
        if credit_info:
            ...
            (fonttag, fontfile, credits_style) = font_for_string(
                fontlist_with_style(fontlist, style_credits_text),
                credits_string
            )
            max_width = MAX_FULL_WIDTH
